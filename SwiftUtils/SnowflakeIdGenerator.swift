...
public class SnowflakeIdGenerator {
    ...
    //
    // @param idBin the id generated by generateId64Bin()
    // @return the extract UNIX timestamp in milliseconds
    public static func extractTimestamp64Bin(idBin: String) -> UInt64 {
    ...
    // Extracts the timestamp part from a 64-bit id generated by generateId64Bin() as a NSDate
    //
    // @param idBin the id generated by generateId64Bin()
    // @return the extract timestamp part as a NSDate
    public static func extractTimestamp64BinAsDate(idBin: String) -> NSDate {
        let timestamp = extractTimestamp64Bin(idBin: idBin)
        return NSDate(timeIntervalSince1970: Double(timestamp) / 1000.0)
    }
    ...
    //
    // @param idBin the id generated by generateId64NilBin()
    // @return the extract UNIX timestamp in milliseconds
    public static func extractTimestamp64NilBin(idBin: String) -> UInt64 {
        let id = strtouq(idBin, nil, 2)
        return extractTimestamp64Nil(id: id)
    }
    ...
    // Extracts the timestamp part from a 64-bit-nil id generated by generateId64NilBin() as a NSDate
    //
    // @param idBin the id generated by generateId64NilBin()
    // @return the extract timestamp part as a NSDate
    public static func extractTimestamp64NilBinAsDate(idBin: String) -> NSDate {
        let timestamp = extractTimestamp64NilBin(idBin: idBin)
        return NSDate(timeIntervalSince1970: Double(timestamp) / 1000.0)
    }
    ...
    //
    // @param idBin the id generated by generateId128Bin()
    // @return the extract UNIX timestamp in milliseconds
    public static func extractTimestamp128Bin(idBin: String) -> UInt64 {
    ...
    // Extracts the timestamp part from a 128-bit id generated by generateId128Bin() as a NSDate
    //
    // @param idBin the id generated by generateId128Bin()
    // @return the extract timestamp part as a NSDate
    public static func extractTimestamp128BinAsDate(idBin: String) -> NSDate {
        let timestamp = extractTimestamp128Bin(idBin: idBin)
        return NSDate(timeIntervalSince1970: Double(timestamp) / 1000.0)
    }
