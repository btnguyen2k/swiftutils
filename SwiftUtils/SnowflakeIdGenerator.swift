...
public class SnowflakeIdGenerator {
    ...
    private static let MASK_TIMESTAMP_64NULL :UInt64 = (1 << 41) - 1  // 41 bits
    private static let MASK_NODE_ID_64NULL   :UInt64 = (1 << 23) - 1  // 23 bits
    private static let SHIFT_TIMESTAMP_64NULL:UInt64 = 23
